...
import com.example.googlemaps.api.ApiClient;
import com.example.googlemaps.api.ApiService;
import com.example.googlemaps.model.ListLocationModel;
import com.example.googlemaps.model.LocationModel;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void getAllDataLocationLatlng(){
        ...
        dialog.setMessage("Menampilkan data market...");
        dialog.show();
